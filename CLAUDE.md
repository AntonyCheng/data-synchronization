...
| `config` | `SeaTunnelProperties` (`sync.engine.*`), `ResourceProtectionPolicy`, `CredentialEncryptionValidator`, `SyncSchedulingConfig` (the module's background-pass scheduler, `sync.scheduler.*`). |
